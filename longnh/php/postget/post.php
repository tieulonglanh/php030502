...
if(isset($_POST['btt_res'])) {
    $name = isset($_POST['txt_name'])?$_POST['txt_name']: "Không rõ tên";
    $year = isset($_POST['txt_nam'])?$_POST['txt_nam']: "Không rõ năm";
    $month = isset($_POST['txt_thang'])?$_POST['txt_thang']: "Không rõ tháng";
    $date = isset($_POST['txt_ngay'])?$_POST['txt_ngay']: "Không rõ ngày";
    $birthdate = $year . "-" . $month . "-" . $date;
    $phone = isset($_POST['txt_phone'])?$_POST['txt_phone']: "Không rõ sđt";
    $mail = isset($_POST['txt_email'])?$_POST['txt_email']: "Không rõ email";
    $sex = isset($_POST['sex'])?$_POST['sex']: "Không rõ giới tính";
...
<html>
    ...
    <center>
        <h2>Register</h2>
        <form method="post" action="/longnh/php/postget/post.php" name="register" >
            <table border="1">
                <tr>
                    <td >Name :</td>
